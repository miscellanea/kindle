...
var calendar = {
    ...
    festival: {
        ...
        '2-14': { title: '\u60c5\u4eba\u8282' }, // 情人节 (Valentine's Day)
        '5-1': { title: '\u52b3\u52a8\u8282' }, // 劳动节 (Labor Day)
        '5-4': { title: '\u9752\u5e74\u8282' }, // 青年节 (Youth Day)
        '6-1': { title: '\u513f\u7ae5\u8282' }, // 儿童节 (Children's Day)
        '9-10': { title: '\u6559\u5e08\u8282' }, // 教师节 (Teacher's Day)
        '10-1': { title: '\u56fd\u5e86\u8282' }, // 国庆节 (National Day)
        '12-25': { title: '\u5723\u8bde\u8282' }, // 圣诞节 (Christmas)
        '3-8': { title: '\u5987\u5973\u8282' }, // 妇女节 (Women's Day)
        '3-12': { title: '\u690d\u6811\u8282' }, // 植树节 (Arbor Day)
        '4-1': { title: '\u611a\u4eba\u8282' }, // 愚人节 (April Fool's Day)
    ...
    lFestival: {
        ...
        '1-1': { title: '\u6625\u8282' }, // 春节 (Spring Festival / Chinese New Year)
        '1-15': { title: '\u5143\u5bb5\u8282' }, // 元宵节 (Lantern Festival)
        '5-5': { title: '\u7aef\u5348\u8282' }, // 端午节 (Dragon Boat Festival)
        '7-7': { title: '\u4e03\u5915\u60c5\u4eba\u8282' }, // 七夕情人节 (Qixi Festival / Chinese Valentine's Day)
        '7-15': { title: '\u4e2d\u5143\u8282' }, // 中元节 (Ghost Festival)
        '8-15': { title: '\u4e2d\u79cb\u8282' }, // 中秋节 (Mid-Autumn Festival)
        '9-9': { title: '\u91cd\u9633\u8282' } // 重阳节 (Double Ninth Festival)
    },
