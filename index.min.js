...
document.addEventListener('DOMContentLoaded', function() {
    ...
    domDate.style.fontSize = (config.fontSize / 6) + "rem";
    domCnDate.style.fontSize = (config.fontSize / 6) + "rem";
    domFestival.style.fontSize = (config.fontSize / 4) + "rem";
    if (domWeather) domWeather.style.fontSize = (config.fontSize / 6) + "rem";
